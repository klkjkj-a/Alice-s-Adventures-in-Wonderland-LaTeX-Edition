\documentclass[book, 20pt]{extbook}
...
\usepackage{hyperref}
\hypersetup{
    bookmarks=true,          % 生成书签（默认 true）
    bookmarksnumbered=true,  % 书签包含章节编号
    bookmarksopen=true,      % 展开书签树
    bookmarksopenlevel=2,    % 自动展开到二级标题
    bookmarksdepth=2,        % 书签深度（2 表示 subsection）
    pdfstartview=FitH,       % 打开时页面宽度自适应
    colorlinks=true,         % 链接用彩色代替方框
...
\setmainfont[renderder=basic]{EB Garamond}
...
\chapter*{\center{{\Large CHAPTER I.\\Down the Rabbit-Hole}}}
...
\chapter*{\center{{\Large CHAPTER II.\\ The Pool of Tears}}}
...
\emph{\noindent Alice's Right Foot, Esq.,\\
\strut~~~~~~~~~~~~~~~Hearthrug,\\
\strut~~~~~~~~~~~~~~~~~~~~~~near the Fender,\\}
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~(\emph{with Alice's love}).
...
\bigskip
\noindent\emph{``How doth the little crocodile}

\emph{Improve his shining tail,\\}
\noindent\emph{And pour the waters of the Nile}

\emph{On every golden scale!\\}
\bigskip
\noindent\emph{``How cheerfully he seems to grin,}

\emph{How neatly spread his claws,\\}
\noindent\emph{And welcome little fishes in}

\emph{With gently smiling jaws!''\\}
\bigskip
...
\chapter*{\center{{\Large CHAPTER III. \\A Caucus-Race and a Long Tale}}}
...
the tale was something like this:---``Fury said to a
...
{\small \strut~~~~`Let us\\
\strut~~~~~~~~~~~~~~both go to\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~law: \emph{I} will\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~prosecute\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\emph{you}.—Come,\vspace{0.4cm}}
\end{spacing}
\begin{spacing}{0.6}
{\footnotesize \strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~I'll take no\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~denial; We\\
\strut~~~~~~~~~~~~~~~must have a\\
\strut~~~~~trial: For\\
\strut~~~really this\\
\strut~~~~~~~~~~~~~~morning I've\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~nothing\\
\strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~to do.'\vspace{0.3cm}}
\end{spacing}
\begin{spacing}{0.6}
{\scriptsize \strut~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Said the\\
\strut~~~~~~~~~~~~~~~~~~~~~~mouse to the\\
\strut~~~~~~~~~~~~~~~~cur, `Such\\
\strut~~~~~~~~~a trial,\\
\strut~~~dear sir,\\
...
\chapter*{\center{{\Large CHAPTER IV. \\The Rabbit Sends in a Little Bill}}}
...
\chapter*{\center{{\Large CHAPTER V. \\Advice from a Caterpillar}}}
...
\bigskip
\noindent\emph{``You are old, Father William,'' the young man said,}

\emph{``And your hair has become very white;\\}

\noindent\emph{And yet you incessantly stand on your head---}

\emph{Do you think, at your age, it is right?''\\}
\bigskip
\noindent\emph{``In my youth,'' Father William replied to his son,}

\emph{``I feared it might injure the brain;\\}
\noindent\emph{But, now that I'm perfectly sure I have none,}

\emph{Why, I do it again and again.''\\}
\bigskip
\noindent\emph{``You are old,'' said the youth, ``as I mentioned before,}

\emph{And have grown most uncommonly fat;\\}
\noindent\emph{Yet you turned a back-somersault in at the door---}

\emph{Pray, what is the reason of that?''\\}
\bigskip
\noindent\emph{``In my youth,'' said the sage, as he shook his grey locks,}

\emph{``I kept all my limbs very supple\\}
\noindent\emph{By the use of this ointment---one shilling the box---}

\emph{Allow me to sell you a couple?''\\}
\bigskip
\noindent\emph{``You are old,'' said the youth, ``and your jaws are too weak}

\emph{For anything tougher than suet;\\}
\noindent\emph{Yet you finished the goose, with the bones and the beak---}

\emph{Pray, how did you manage to do it?''\\}
\bigskip
\noindent\emph{``In my youth,'' said his father, ``I took to the law,}

\emph{And argued each case with my wife;\\}
\noindent\emph{And the muscular strength, which it gave to my jaw,}

\emph{Has lasted the rest of my life.''\\}
\newpage
\noindent\emph{``You are old,'' said the youth, ``one would hardly suppose}

\emph{That your eye was as steady as ever;\\}
\noindent\emph{Yet you balanced an eel on the end of your nose---}

\emph{What made you so awfully clever?''\\}
\bigskip
\noindent\emph{``I have answered three questions, and that is enough,''}

\emph{Said his father; ``don't give yourself airs!\\}
\noindent\emph{Do you think I can listen all day to such stuff?}

\emph{Be off, or I'll kick you down stairs!''\\}
\bigskip
...
\chapter*{\center{{\Large CHAPTER VI. \\Pig and Pepper}}}
...
\bigskip
\noindent\emph{``Speak roughly to your little boy,}

\emph{And beat him when he sneezes:\\}
\noindent\emph{He only does it to annoy,}

\emph{Because he knows it teases.''}

\begin{center}
CHORUS.\\
(In which the cook and the baby joined):---\\

\center\emph{``Wow! wow! wow!''}
\end{center}
...
\bigskip
\noindent\emph{``I speak severely to my boy,}

\emph{I beat him when he sneezes;\\}
\noindent\emph{or he can thoroughly enjoy}

\emph{The pepper when he pleases!''}
...
\chapter*{\center{{\Large CHAPTER VII. \\A Mad Tea-Party}}}
...
\bigskip
{\centering
\emph{`Twinkle, twinkle, little bat!\\
How I wonder what you're at!'}\par}
\bigskip
...
\bigskip
{\centering
\emph{`Up above the world you fly,\\
Like a tea-tray in the sky.}\par}
\hfill {Twinkle, twinkle---'\,''\\}
\bigskip
...
\chapter*{\center{{\Large CHAPTER VIII. \\The Queen's Croquet-Ground}}}
...
\chapter*{\center{{\Large CHAPTER IX. \\The Mock Turtle's Story}}}
...
\chapter*{\center{{\Large CHAPTER X. \\The Lobster Quadrille}}}
...
\noindent\emph{``Will you walk a little faster?'' said a whiting to a snail.\\}
\noindent\emph{``There's a porpoise close behind us, and he's treading on my tail.\\}
\noindent\emph{See how eagerly the lobsters and the turtles all advance!\\}
\noindent\emph{They are waiting on the shingle---will you come and join the dance?}

\emph{Will you, won't you, will you, won't you, will you join the dance?}

\emph{Will you, won't you, will you, won't you, won't you join the dance?\\}
\bigskip
\noindent\emph{``You can really have no notion how delightful it will be\\}
\noindent\emph{When they take us up and throw us, with the lobsters, out to sea!''\\}
\noindent\emph{But the snail replied ``Too far, too far!'' and gave a look askance---\\}
\noindent\emph{Said he thanked the whiting kindly, but he would not join the dance.}

\emph{Would not, could not, would not, could not, would not join the dance.}

\emph{Would not, could not, would not, could not, could not join the dance.\\}
\bigskip
\noindent\emph{``What matters it how far we go?'' his scaly friend replied.\\}
\noindent\emph{``There is another shore, you know, upon the other side.\\}
\noindent\emph{The further off from England the nearer is to France---\\}
\noindent\emph{Then turn not pale, beloved snail, but come and join the dance.}
...
very queer indeed:---\\
\bigskip
\noindent\emph{``\,'Tis the voice of the Lobster; I heard him declare,\\}
\noindent\emph{``You have baked me too brown, I must sugar my hair.''\\}
\noindent\emph{As a duck with its eyelids, so he with his nose\\}
\noindent\emph{Trims his belt and his buttons, and turns out his toes.''\\}
\bigskip
\strut
{[}later editions continued as follows\\
\bigskip
\noindent\emph{When the sands are all dry, he is gay as a lark,\\}
\noindent\emph{And will talk in contemptuous tones of the Shark,\\}
\noindent\emph{But, when the tide rises and sharks are around,\\}
\noindent\emph{His voice has a timid and tremulous sound.}{]}\\
\bigskip
...
\bigskip
\noindent\emph{``I passed by his garden, and marked, with one eye,\\}
\noindent\emph{How the Owl and the Panther were sharing a pie---''\\}
\bigskip
\strut
{[}later editions continued as follows\\
\bigskip
\noindent\emph{The Panther took pie-crust, and gravy, and meat,\\}
\noindent\emph{While the Owl had the dish as its share of the treat.\\}
\noindent\emph{When the pie was all finished, the Owl, as a boon,\\}
\noindent\emph{Was kindly permitted to pocket the spoon:\\}
\noindent\emph{While the Panther received knife and fork with a growl,\\}
\noindent\emph{And concluded the banquet---}{]}\\
\bigskip
...
\bigskip
\noindent\emph{``Beautiful Soup, so rich and green,\\}
\noindent\emph{Waiting in a hot tureen!\\}
\noindent\emph{Who for such dainties would not stoop?\\}
\noindent\emph{Soup of the evening, beautiful Soup!\\}
\noindent\emph{Soup of the evening, beautiful Soup!\\}

\emph{Beau---ootiful Soo---oop!}

\emph{Beau---ootiful Soo---oop!\\}
\noindent\emph{Soo---oop of the e---e---evening,\\}

\emph{Beautiful, beautiful Soup!\\}
\bigskip
\noindent\emph{``Beautiful Soup! Who cares for fish,\\}
\noindent\emph{Game, or any other dish?\\}
\noindent\emph{Who would not give all else for two\\}
\noindent\emph{Pennyworth only of beautiful Soup?\\}
\noindent\emph{Pennyworth only of beautiful Soup?\\}
...
\emph{Beautiful, beauti---FUL SOUP!''\\}
\bigskip
...
\chapter*{\center{{\Large CHAPTER XI. \\Who Stole the Tarts?}}}
...
\bigskip
\noindent\emph{``The Queen of Hearts, she made some tarts,}

\emph{All on a summer day:\\}

\noindent\emph{The Knave of Hearts, he stole those tarts,}

\emph{And took them quite away!''\\}
\bigskip
...
\chapter*{\center{{\Large CHAPTER XII. \\Alice's Evidence}}}
...
\bigskip
\noindent\emph{``They told me you had been to her,}

\emph{And mentioned me to him:\\}

\noindent\emph{She gave me a good character,}

\emph{But said I could not swim.\\}
\bigskip
\noindent\emph{He sent them word I had not gone}

\emph{(We know it to be true):\\}

\noindent\emph{If she should push the matter on,}

\emph{What would become of you?\\}
\bigskip
\noindent\emph{I gave her one, they gave him two,}

\emph{You gave us three or more;\\}

\noindent\emph{They all returned from him to you,}

\emph{Though they were mine before.\\}
\bigskip
\noindent\emph{If I or she should chance to be}

\emph{Involved in this affair,\\}

\noindent\emph{He trusts to you to set them free,}

\emph{Exactly as we were.\\}
\bigskip
\noindent\emph{My notion was that you had been}

\emph{(Before she had this fit)\\}

\noindent\emph{An obstacle that came between}

\emph{Him, and ourselves, and it.\\}
\bigskip
\noindent\emph{Don't let him know she liked them best,}

\emph{For this must ever be\\}

\noindent\emph{A secret, kept from all the rest,}

\emph{Between yourself and me.''\\}
\bigskip
